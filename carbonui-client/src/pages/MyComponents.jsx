        ...
        <AnimatePresence mode='wait'>
          ...
          {activeTab === "guide" && (
            ...
            >
              ...
              <div>
              <p className='text-[10px] fomt-bold text-white/50 mb-3
              flex items-center gap-2'>
                <TbCode size={13}/>
                <span className='text-[#3be8ff] font-bold'>
                  01
                </span>
              ...
              <CodeBlock code={`${component.name}.jsx`} lang='jsx'/>
              </div>
    ...
    style={{fontFamily:"`Dm Sans`, sans-serif"}}>
      ...
      style={{height:"calc(100vh - 57px)"}}>
        ...
        border-white/[0.06] bg-[#040e11] overflow-hidden'>
          ...
          onSelect={handleSelect} myComponents={myComponents}
          />
        </aside>
