...
import { TbBox, TbBrandNpm, TbCheck, TbChevronRight, TbCode, TbCopy, TbEye, TbLayoutSidebarLeftExpand, TbMenu2, TbPackage, TbSearch, TbX } from 'react-icons/tb';
...
function CopyBtn({text}){
  ...
  return(
    ...
    text-white/30 hover:text-white/60 transition-colors bg-transparent border-none
...
function GuidePanel(){
  ...
  return(
    ...
    sm:px-8 text-center py-10 sm:py-16'>
      ...
      >
        ...
        <div className='w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-[#3be8ff]/[0.07]
           border border-[#3be8ff]/15 flex items-center justify-center mx-auto
           mb-5 sm:mb-6'>
            <TbPackage size={24} className='text-[#3be8ff]'/>
        </div>
         {
              userData?(
                  <>
            ...
            <div className='w-full max-w-md mx-auto text-left space-y-4 mb-8'>
              ...
              <p className='text-[10px] fot-bold tracking-[3px] uppercase text-[#3be8ff]/50
              mb-4'>
                Quick Start Guide
              </p>
              ...
              <span className='text-[#3be8ff]/60 fomt-bold'>
               01
              </span>
              Install the package
              </p>
              ...
              <CodeBlock code={`import {componentName} from 'carbon-ui-lib'`} lang='jsx'/>
              </div>
              ...
              <CodeBlock
                lang="jsx"
                code={`import { UserAvatar, PricingCard } from "carbon-ui-lib";
...
function DetailPanel({component,onBack}){
  ...
  const importCode = `import {${component.name}} from "carbon-ui-lib";`
  const usageCode = `import {${component.name}} from "carbon-ui-lib";\n\nexport default
   function App(){\n return (\n <div> \n  <${component.name}${
  ...
  return(
    ...
    >
      ...
      px-4 sm:px-6 py-4 sm:py-5 border-b border-white/[0.06] gap-3 flex-wrap'>
        ...
        <div className='flex items-center gap-3 min-w-0 flex-1'>
          ...
          <div className='min-w-0 flex-1'>
            ...
            <p className='mt-0.5 truncate text-[11px] sm:text-xs text-white/35'>
        ...
        <div className='flex gap-1 rounded-xl overflow-x-auto shrink-0'
        style={{background:"rgba(0,0,0,0.3)"}}>
          ...
          {[
            ...
            style={{background:activeTab === id?"rgba(59,232,255,0.15)":
              "transparent",
                ...
                <div>
                    ...
                    border-white/[0.06]'>
                      <table className='w-full text-xs'>
                        <thead>
                          <tr className='boder-b border-white/[0.05] bg-white/[0.02]
                          '>
                        ...
                        <tbody>
                          {component.props.map((p,i)=>(
                            ...
                            last:border-0'>
                              ...
                              {p}</td>
                              <td className='px-4 py-2.5  text-white/20'>
                              any</td>
                            </tr>
                          ))}
    ...
    <div className='flex-1 overflow-y-auto py-1 px-2'>
      {publicComponents.length===0?(
        ...
        publicComponents.map((c)=>(
          ...
          rounded-xl text-sm transition-all cursor-pointer border text-left
          mb-0.5'
          style={{
          ...
          >
            <span className='truncate fomt-medium text-xs'>
              {c.name}
              </span>
              {selected?._id === c._id && <TbChevronRight size={13} className='shrink-0
              ml-1'/>}
    ...
    style={{fontFamily:"`Dm Sans`, sans-serif"}}>
      ...
      backdrop-blur-md shrink-0'>
          ...
          <div className='flex items-center'>
            ...
            className='sm:hidden flex items-center justify-center w-8
      ...
      style={{height:"calc(100vh - 57px)"}}>
        ...
        <AnimatePresence>
          ...
          {sidebaropen && (
            ...
            className='sm:hidden fixed inset-0 z-59 bg-black/60 
            backdrop-blur-sm'
            />
            <motion.div
             initial={{x:"-100%"}}
            ...
            flex-col bg-[#040e11] border-r border-white/[0.08]'
            >
              ...
              border-b border-white/[0.06]'>
                  ...
                  <button className='w-7 h-7 rounded-lg flex items-center
                  justify-center text-white/40 hover:text-white/70 hover:bg-white/[0.06]
                  transition-colors cursor-pointer bg-transparent border-none'>
                    <TbX onClick={()=>setSidebarOpen(false)} size={14}/>
                  </button>
              </div>
              <SidebarComponent selected={selected} search={search} 
              setSearch={setSearch} onSelect={handleSelect} 
