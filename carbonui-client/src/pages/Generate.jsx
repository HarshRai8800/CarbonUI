...
function Generate() {
  ...
  return (
    ...
    >
        ...
        <div className='absolute bottom-[-10%] right-[-5%] w-80 h-80
        rounded-full pointer-events-none opacity-15'
        ...
        />
          ...
          >
            ...
            >
              ...
              style={{fontFamily:"'Space Grotesk',sans-serif",letterSpacing:
                "-0.03"
              }}>

                <span className='text-white'>Build with</span>
                <span style={{background:"linear-gradient(135deg, #818cf8 0%,#06b6d4 100%)",
                ...
                <motion.div
                  ...
                  <FiZap size={13} style={{color:lowCredits? "#f87171": "#818cf8"}}/>
                    <span className='text-xs font-semibold' style={{color:
                      lowCredits ? "#f87171":"#818cf8"
                    }}> {aiCredits} AI Credits </span>
            ...
            >
                ...
                value={prompt}
                placeholder={lowCredits? "Not enough credits to generate...":
                "A glassmorphism pricing card with a toggle for monthly/annual billing..."}
                disabled={lowCredits}
                rows={3}
                className='w-full bg-transparent text-white placeholder-white/20
                text-[15px] resize-none outline-none leading-relaxed disabled:cursor-not-allowed'/>
              </div>
...

          {
            !generated && !generating &&(
              ...
              >
                ...
                Describe your component above and hit Generate</p>
              </motion.div>
            )
          }
