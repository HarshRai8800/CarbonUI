...
const features = [
  {icon:TbLayout,title:"Prebuilt UI components",text:"Install CarbonUI and use redy-made , production-grade components instantly"},
  {icon:HiSparkles,title:"AI Components Generator",text:"Describe your UI in plain English and genrate React compoents in seconds."},
  {icon:TbAdjustments,title:"Customizable Props",text:"Modify compoents props and preveiw changes in real-time without rebuilding"},
  {icon:TbCode,title:"Clean JSX Code",text:"Copy production-redy JSX directly into your project-zero boilerplate."},
  {icon:TbBrandNpm,title:"NPM Library",text:"Import carbonUI components with a simple npm instal command."},
  {icon:TbPlayerPlay,title:"Live Preview",text:"Instantly preveiw Ai-generated components before exporting your code"},
]

const steps=[
  {n:"01",title:"Install Library",text:"npm install carbon-ui-library to access all prebuilt UI components"},
  {n:"02",title:"Use Components",text:"Import and customize with props for any design requirements."},
  {n:"03",title:"Generate with AI",text:"Describe your UI and let Ai build the compoent for you."},
    ...
    >
      ...
      '/>
        ...
        '/>
          ...
          <nav className='sticky top-0 z-40 flex items-center justify-between px-4
          ...
          backdrop-blur-md'>
            ...
            <div className='flex items-center gap-2.5 '>
              ...
              to-[#0ab544] flex items-center justify-center shadow-[0_0_14px_rgba(59,232,255,0.4)]'>
                ...
                components </button>
                  ...
                  (
                    <div className='relative'>
                        ...
                        className='flex items-center gap-2.5 bg-white/[0.06]
                        border border-white/10 hover:border-[#3be8ff]/30 px-3 py-1.5
                        rounded-xl transition-all cursor-pointer'
                        >
                          <div className='w-7 h-7 rounded-lg bg-gradient-to-br from-[#3be8ff] to-[#0ab5d4]
                          flex items-center justify-center text-[rgb(3,11,13)] text-[11px] font-bold                          '>
                  ...
                  (
                   ...
                   border-none shadow-[0_0_30px_rgba(59,232,255,0.4)] transition-shadow text-nowrap'
                  >
            ...
            className='md:hidden tex-white/60 hover:text-white
          ...
          <AnimatePresence>
          {
            menuOpen&&(
              ...
              exit={{opacity:0,y:-10}}
              className='md:hidden sticky top-[65px] bg-[#030b0d]/95
              ...
              >
                ...
                transition-all cursor-pointer bg-transparent w-full'>Components</button>
                  {userData?(
                    <>
                    <div className='flex items-center gap-2.5 py-2 border-t
                    border-white/[0.07]'>
                  ...
                  <button onClick={()=>setShowAuth(true)} className='flex items-center justify-center gap-2 bg-[#3be8ff]
                  text-[#030b0d] px-4 py-2.5 rounded-lg text-sm
                  font-semibold cursor-pointer border-none mt-1'>
                    <HiSparkles size={14}/>
          ...
          <section className='relative max-w-5xl mx-auto px-4 sm:px-6 pt-16
          sm:pt-24 pb-12 sm:pb-20 text-center'>
            <motion.div
            initial={{opacity:0,y:22}}
            animate={{opacity:1,y:0}}
            transition={{delay:0.05,duration:0.6}}
            className='inline-flex items-center gap-2 text-[10px] font-semibold
            tracking-[2.5px] uppercase text-[#3be8ff]/70 border border-[#3be8ff]/20
            bg-[#3be8ff]/[0.05] rounded-full px-4 py-1.5 mb-6 sm:mb-7'>
            <span className="w-1.5 h-1.5 rounded-full bg-[#3be8ff] animate-pulse" ></span>
              AI-Powered react UI Libraray
            </motion.div>
            ...
            leading-[1.08] tracking-tight mb:5 sm:mb-6' style={{fontFamily:"'Syne',sans-serif"}}>
              Build React UI<br/>
              <span className='text-transparent bg-clip-text bg-gradient-to-r from-[#3be8ff]
              to-[#0ab5d4]'>
                Faster with AI
              </span>
            </motion.h1>
            ...
            className='text-white/50 text-base sm:text-lg max-w-xl mx-auto
             loading-relaxed mb-8 sm:mb-10 font-light px-2'>
                Use prebuilt CarbonUI components or generate custom ones with AI.
            ...
            className='flex justify-center mb-7 sm:mb-8 px-2'>
              ...
              sm:text-sm font-momo w-full max-w-xs sm:max-w-fit'>
                ...
                flex-shrink-0'>
                  {copied?<TbCheck size={15} className='text-[#3be8ff]'/>:
                  <TbCopy size={15}/>}
                </button>
              </div>
          ...
          py-3.5 bg-white text-[#030b0d] rounded-xl font-semibold text-sm
          cursor-pointer border-none shadow-[0_4px_24px_rgba(255,255,255,0.1)]
        ...
        whileHover={{ y: -2 }}
        whileTap={{ scale: 0.97 }}
        className='flex items-center justify-center gap-2 px-6 m:px-7 py-3.5
        border border-white/15 rounded-xl text-sm text-white/70
        ...
        className='mt-12 sm:mt-16 mx-auto max-w-2xl bg-[#0a1a1e]/80
         border border-white/[0.07] rounded-2xl p-4 sm:p-5 text-left shadow-[0_30px_60px_rgba(0,0,0,0.4)]
         backdrop-blur-sm overflow-x-auto'>
          <div className='flex items-center gap-1.5 mb-4'>
            <div className='w-2.5 h-2.5 rounded-full bg-[#ff5f57]'/>
            <div className='w-2.5 h-2.5 rounded-full bg-[#febc2e]'/>
            <div className='w-2.5 h-2.5 rounded-full bg-[#28c840]'/>
            <span className='ml-3 text-[11px] text-white/20 font-momo'>App.jsx</span>
          </div>
          <div className='font-mono text-[11px] sm:text-[12.5px] leading-6
          space-y-0.5 min-w-[280px]'>
            <p>
              <span className='text-[#3be8ff]/60'>import</span> <span
              className='text-white/80'>{"{Button, Card}"}</span> <span
              className='text-[#3be8ff]/60'>from</span> <span 
              className='text-[#aaff80]/70'>carbon-ui-library</span>
              <span className='text-white/30'>;</span>
            </p>
            <p>{" "}</p>
            <p><span className='text-[#3be8ff]'>export default function
              </span> <span className='text-[#ffd580]'>App</span><span className='text-white/50'>
              () {"{"}</span></p>
              <p><span className="text-white/30">{"  return ( "}</span></p>
              <p><span className='text-white/30'>{"     <"}</span><span className='text-[#3be8ff]'>Card</span> <span className='text-[#aaff80]'>title</span> 
               <span className='text-[#aaff80]/70'>{"="}</span>
               <span className='text-white/30'>{"\"Dashboard\""}</span>
               <span className='text-white/30'>{">"}</span>

               <p><span className='text-white/30'>{"     <"}</span>
               <span className='text-[#3be8ff]'>Button</span> <span className='text-[#aaff80]'>text</span> 
               <span className='text-[#aaff80]/70'>{"="}</span>
               <span className='text-white/30'>{"\"hello\""}</span> 
               <span className='text-white/30'>{"/>"}</span>
               <span></span></p> <span></span></p>
               <p><span className='text-white/30'>{"   </"}</span><span className='text-[#3be8ff]/70'>Card</span><span
          ...
          <section className='max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-24'>
            ...
            gap-4'>
              {features.map((item,index)=>(
                ...
                key={index} className='group p-5 sm:p-6 rounded-2xl
                border border-white/[0.07] bg-white/[0.02] hover:bg-[#3be8ff]/[0.04]
                hover:border-[#3be8ff]/20 transition-all duration-300 '>
                    <div className='w-10 h-10 rounded-xl bg-[#3be8ff]/[0.08]
                    border border-[#3be8ff]/15 flex items-center justify-center
                    mb-4 group-hover:bg-[#3be8ff]/15 transition-colors'>
          ...
          <section className='max-w-5xl mx-auto px-4 sm:px-6 py-16 sm:py-24'>
            ...
            <div className='relative grid grid-cols-2
             lg:grid-cols-4 gap-6 sm:gap-8'>

                <div className='hidden lg:block absolute top-8 left-[12.5%] right-[12.5%]
                 h-px bg-gradient-to-r from-transparent via-[#3beaff]/20
                to-transparent'/>
                ...
                {steps.map((item,index)=>(
                  ...
                  className='relative text-center group'>
                    ...
                    rounded-2xl bg-gradient-to-br from-[#0e2528] to-[#071518]
                    border border-[#3be8ff]/20 flex flex-col items-center justify-center
                    group-hover:border-[#3be8ff]/40 group-hover:shadow-[0_0_20px_rgba(59,232,255,0.1)]
                    transition-all duration-300 '
                    >
                      <span className='text-[9px] text-[#3be8ff]/60 font-bold
                      tracking-widest'>{item.n}</span>
                    </div>
                    <h3 className='font-semibold text-white/90 mb-2 text-[13px]
                    sm:text-[14px]'>{item.title}</h3>
                    <p className='text-[11px] sm:text-xs text-white/40
                    leading-relaxed'>{item.text}</p>
                  </motion.div>
                ))}
             </div>
          </section>
          <section  className='max-w-5xl mx-auto px-4 sm:px-6 py-16 sm:py-24'>
            ...
            border-[#3be8ff]/15 bg-gradient-to-br from-[#071518]
            to-[#040f12] p-8 sm:p-14 text-center overflow-hidden'>

              <div className='absolute inset-0 bg-[radial-gradient(ellipse_at_50%_0%,rgba(59,232,255,0.08)_0%,transparent_60%)]
              pointer-events-none'/>

              <div className='relative z-10'>
              <p className='text-[10px] font-semibold tracking-[3px] uppercase
              text-[#3be8ff]/60 mb-3 sm:mb-4 '>
                Start building
              </p>
              <h3 className='text-3xl sm:text-4xl font-bold tracking-tight mb-3
               sm:mb-4' style={{fontFamily:"'Syne',sans-serif"}}>
               ...
               {userData?(
                ...
                leading-relaxed'>
                  Welcome back, <span className='text-[#3be8ff]/70'>
                  {userData.name}
                ...
                <div className='flex flex-col sm:flex-row justify-center gap-3'>
                  ...
                  text-[#030b0d] px-7 py-3.5 rounded-xl font-semibold text-sm
                  cursor-pointer border-none shadow-[0_0_30px_rgba(59,232,255,03)]
                  ...
                  hover:border-white/25 transition-all cursor-pointer bg-transparent'                           
                  >
                  <TbComponents size={16} className='text-[#3be8ff]/70'/>
                   My Components
                  </motion.button>
            ...
            items-center justify-between gap-4 sm:gap-0'>
              ...
              text-white/30'>
                ...
                <span className='hover:text-white/60'>
                  admin@carbonUI.com</span>
              </div>
              <p className='text-xs text-white/25 order-last sm:order-none'>
               © {new Date().getFullYear()} Carbon UI. All rights reserved.
            </p>
            </div>
