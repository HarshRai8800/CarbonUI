  ...
  return (
    ...
    >
      <div style={{ position: "relative", width: "100%", height: "200px", overflow: "hidden" }}>
        ...
        <div style={{ position: "absolute", bottom: "12px", left: "12px", padding: "4px 10px", borderRadius: "20px", background: alpha(accent, 0.85), fontSize: "10px", fontWeight: "700", color: "#fff", textTransform: "uppercase", letterSpacing: "0.5px" }}>{rating} ★</div>
      </div>
      <div style={{ padding: "18px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "18px" }}>
          <span style={{ fontSize: "18px", fontWeight: "800", color: "#fff" }}>{currency}{price}</span>
          <button
            onClick={onAddToCart}
